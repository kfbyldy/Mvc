...
";
            ...
            Assert.Equal(
                "System.Linq.Expressions.Expression<System.Func<object, object>>",
...
";
            ...
            var declaration = field.Declaration;
            Assert.Equal(
                "System.Linq.Expressions.Expression<System.Func<Person, object>>",
                declaration.Type.ToString());
...
";
            ...
            var declaration = field.Declaration;
            Assert.Equal(
                "System.Linq.Expressions.Expression<System.Func<Person, int>>",
                declaration.Type.ToString());
